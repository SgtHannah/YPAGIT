...
*/
{
    ...
    if (ywd->DefTooltips) {
        ...
        t[TOOLTIP_SHELL_QUITGAME]       = "UHHHMMM... QUIT? YEAH RIGHT, DUDE, KILL IT!";
        ...
        t[TOOLTIP_SHELL_GOTOLOADSAVE]   = "GOTO LOAD/SAVE SCREEN";
        t[TOOLTIP_SHELL_SETTINGS3D]     = "SELECT 3D DEVICE";
        t[TOOLTIP_SHELL_SENDMESSAGE]    = "SEND THIS MESSAGE";
