...
**      22-Mar-98   floh    + FirstShown wurde nicht angepaﬂt, wenn
...
**                            tats‰chlich eine Mausbewegung passiert
**                            ist.
*/
{
...
/*
**  FUNCTION
**      Beendet den aktuellen Drag-Vorgang und lˆst u.U.
**      den Transfer aus...
**
**  CHANGED
**      26-Mar-96   floh    created
...
*/
{
    ...
    /*** Maus ¸ber g¸ltiger Finder-Position? ***/
...
*/
{
    if (!(FR.l.Req.flags & (REQF_Iconified|REQF_Closed))) {
        ...
        if (FR.flags & FRF_Dragging) {
            ...
            /*** Tooltip-Handling f¸r die aktuelle Geschwader-Aktion ***/
            if (FR.l.MouseItem != -1) {
